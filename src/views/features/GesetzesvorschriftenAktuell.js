              ...
              <CAccordion activeItemKey={1}>
                <CAccordionItem itemKey={1}>
                  ...
                  <CAccordionBody>
                    <CListGroup>
                      <CListGroupItem>
                        Dashboard mit der Visualisierung deines Einhame, Total Verkauf, Mitglieder und wichtige Metrics
                      </CListGroupItem>
                      <CListGroupItem>
                        Editierbar Tabelle um effektive die mehrere und verschiedene Transaktion zu bearbeiten und speichern
                      </CListGroupItem>
                      <CListGroupItem>Gesetztvorschift</CListGroupItem>
                      <CListGroupItem>
